...
#define ANA_NUDGCOEF      /*Analytical open-boundary nudging coefficients.*/
#define ANA_TCLIMA        /*Needed only to size Tnudgcof; value unused by OBC nudging.*/
#define ANA_M3CLIMA       /*Needed to allocate uclm/vclm for the rhs3d.F interior nudging term.*/
#define UV_VIS2           /*Explicit horizontal viscosity.*/
#ifdef  UV_VIS2
