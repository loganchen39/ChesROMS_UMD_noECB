...
!
#ifdef PROFILE
      CALL wclock_on (ng, iTLM, 28, __LINE__, MyFile)
#endif
      CALL tl_t3dmix4_geo_tile (ng, tile,                               &
     &                          LBi, UBi, LBj, UBj,                     &
...
!!   &                          DIAGS(ng) % DiaTwrk,                    &
     ...
     &                          OCEAN(ng) % tl_t)
#ifdef PROFILE
      CALL wclock_off (ng, iTLM, 28, __LINE__, MyFile)
#endif
!
      RETURN
...
!
!***********************************************************************
      SUBROUTINE tl_t3dmix4_geo_tile (ng, tile,                         &
     &                                LBi, UBi, LBj, UBj,               &
     &                                IminS, ImaxS, JminS, JmaxS,       &
     &                                nrhs, nstp, nnew,                 &
#ifdef MASKING
...
!
      RETURN
      END SUBROUTINE tl_t3dmix4_geo_tile
