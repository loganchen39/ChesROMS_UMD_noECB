...
!
#ifdef PROFILE
      CALL wclock_on (ng, iTLM, 33, __LINE__, MyFile)
#endif
      CALL tl_uv3dmix4_geo_tile (ng, tile,                              &
     &                           LBi, UBi, LBj, UBj,                    &
...
#ifdef PROFILE
      CALL wclock_off (ng, iTLM, 33, __LINE__, MyFile)
#endif
!
      RETURN
...
!
!***********************************************************************
      SUBROUTINE tl_uv3dmix4_geo_tile (ng, tile,                        &
     &                                 LBi, UBi, LBj, UBj,              &
     &                                 IminS, ImaxS, JminS, JmaxS,      &
     &                                 nrhs, nnew,                      &
#ifdef MASKING
...
!
      RETURN
      END SUBROUTINE tl_uv3dmix4_geo_tile
