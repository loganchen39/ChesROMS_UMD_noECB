...
!
#ifdef PROFILE
      CALL wclock_on (ng, iADM, 33, __LINE__, MyFile)
#endif
      CALL ad_uv3dmix4_geo_tile (ng, tile,                              &
     &                           LBi, UBi, LBj, UBj,                    &
...
#ifdef PROFILE
      CALL wclock_off (ng, iADM, 33, __LINE__, MyFile)
#endif
!
      RETURN
...
!
!***********************************************************************
      SUBROUTINE ad_uv3dmix4_geo_tile (ng, tile,                        &
     &                                 LBi, UBi, LBj, UBj,              &
     &                                 IminS, ImaxS, JminS, JmaxS,      &
     &                                 nrhs, nnew,                      &
#ifdef MASKING
...
!
      RETURN
      END SUBROUTINE ad_uv3dmix4_geo_tile
