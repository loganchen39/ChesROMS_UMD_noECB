...
!
#ifdef PROFILE
      CALL wclock_on (ng, iRPM, 29, __LINE__, MyFile)
#endif
      CALL rp_t3dmix4_iso_tile (ng, tile,                               &
     &                          LBi, UBi, LBj, UBj,                     &
...
!!   &                          DIAGS(ng) % DiaTwrk,                    &
     ...
     &                          OCEAN(ng) % tl_t)
#ifdef PROFILE
      CALL wclock_off (ng, iRPM, 29, __LINE__, MyFile)
#endif
!
      RETURN
...
!
!***********************************************************************
      SUBROUTINE rp_t3dmix4_iso_tile (ng, tile,                         &
     &                                LBi, UBi, LBj, UBj,               &
     &                                IminS, ImaxS, JminS, JmaxS,       &
     &                                nrhs, nstp, nnew,                 &
#ifdef MASKING
...
# ifdef TL_IOMS
     &                  (0.5_r8-SIGN(0.5_r8,                            &
     &                               pden(i,j,k)-pden(i,j,k+1)-eps))*eps
# endif
                cff=-1.0_r8/cff1
                tl_cff=cff*cff*tl_cff1+                                 &
# ifdef TL_IOMS
...
!
      RETURN
      END SUBROUTINE rp_t3dmix4_iso_tile
