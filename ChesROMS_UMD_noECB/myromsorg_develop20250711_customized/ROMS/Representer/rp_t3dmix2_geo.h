...
!
#ifdef PROFILE
      CALL wclock_on (ng, iRPM, 25, __LINE__, MyFile)
#endif
      CALL rp_t3dmix2_geo_tile (ng, tile,                               &
     &                          LBi, UBi, LBj, UBj,                     &
...
!!   &                          DIAGS(ng) % DiaTwrk,                    &
     ...
     &                          OCEAN(ng) % tl_t)
#ifdef PROFILE
      CALL wclock_off (ng, iRPM, 25, __LINE__, MyFile)
#endif
!
      RETURN
...
!
!***********************************************************************
      SUBROUTINE rp_t3dmix2_geo_tile (ng, tile,                         &
     &                                LBi, UBi, LBj, UBj,               &
     &                                IminS, ImaxS, JminS, JmaxS,       &
     &                                nrhs, nstp, nnew,                 &
#ifdef MASKING
...
!
      RETURN
      END SUBROUTINE rp_t3dmix2_geo_tile
