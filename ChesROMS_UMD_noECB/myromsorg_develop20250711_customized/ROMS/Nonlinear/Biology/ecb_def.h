...
************************************************************************
**                                                                    **
**  Defines the Estuarine Carbon Biogeochemistry model (Feng et al.,  **
**  2015, and follow-ups) parameters into output NetCDF files. It is  **
**  included in routine "def_info.F".                                 **
**                                                                    **
************************************************************************
*/

!
!  Define the Estuarine Carbon Biogeochemistry model (Feng et al.,
...
!
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='Vp0'
      Vinfo( 2)='Temperature-limited phytoplankton growth parameter'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, __LINE__, MyFile)) RETURN
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 3)='meter3 millimole_phosphorus-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, __LINE__, MyFile)) RETURN
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='ZooGR'
      Vinfo( 2)='zooplankton maximum growth rate at 0C'
      Vinfo( 3)='day-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 3)='m3 millimole_N-1 day-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, __LINE__, MyFile)) RETURN
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='RDeRRN'
      Vinfo( 2)='remineralization rate for semilabileDON at 0C'
      Vinfo( 3)='day-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='RDeRRC'
      Vinfo( 2)='remineralization rate for semilabileDOC at 0C'
      Vinfo( 3)='day-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='rkd1'
      Vinfo( 2)='light attenuation by CDOM in freshwater (S=0)'
      Vinfo( 3)='meter-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='rkdTSS1'
      Vinfo( 2)='light attenuation by Total Suspended Solids (TSS)'
      Vinfo( 3)='meter2 g-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='rkdS1'
      Vinfo( 2)='light attenuation by CDOM (slope of relation with S)'
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='deltC'
      Vinfo( 2)='ratio of semilabile DOC to total DOC in cell'
      Vinfo( 3)=''
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='gammaC'
      Vinfo( 2)='parameter of carbon excess-based DOC exudation'
      Vinfo( 3)=''
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='slCexc'
      Vinfo( 2)='fraction of semilabile DOC produced by C excess uptake'
      Vinfo( 3)=''
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
