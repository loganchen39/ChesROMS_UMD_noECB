      MODULE t3dmix2_mod
!
!git $Id: 856b8abf 2025-03-19 14:33:28 UTC arango $
!=======================================================================
...
!
#ifdef PROFILE
      CALL wclock_on (ng, iNLM, 26, __LINE__, MyFile)
#endif
      CALL t3dmix2_iso_tile (ng, tile,                                  &
     &                       LBi, UBi, LBj, UBj,                        &
     ...
     &                       OCEAN(ng) % t)
#ifdef PROFILE
      CALL wclock_off (ng, iNLM, 26, __LINE__, MyFile)
#endif
!
      RETURN
...
!
!***********************************************************************
      SUBROUTINE t3dmix2_iso_tile (ng, tile,                            &
     &                             LBi, UBi, LBj, UBj,                  &
     &                             IminS, ImaxS, JminS, JmaxS,          &
     &                             nrhs, nstp, nnew,                    &
#ifdef MASKING
...
!
      RETURN
      END SUBROUTINE t3dmix2_iso_tile
